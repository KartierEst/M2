...
build_dir="./tmp_build"
src_dir="./src"
jarname="CoolGraphicsJar.jar"
interface_provided="fr.uge.poo.paint.ex9.CanvaFactory"
class_providing_the_interface="fr.uge.poo.paint.ex9.CoolGraphicsAdaptedFactory"
included_classes=("fr.uge.poo.paint.ex9.CoolGraphicsAdapted" "com.evilcorp.coolgraphics.CoolGraphics" "$interface_provided" "$class_providing_the_interface")
